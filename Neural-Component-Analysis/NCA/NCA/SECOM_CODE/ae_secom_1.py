...
def get_data():
    train_data, test_data = util_secom.read_secom_data()
    train_data = preprocessing.StandardScaler().fit_transform(train_data)
    test_data = preprocessing.StandardScaler().fit_transform(train_data)
    return train_data.astype(np.float32),test_data.astype(np.float32)  # 转换为float32
...
def main():
    ...
    # 保存结果
    #util_secom.write_data('7_spe_train_ae', spe_train.numpy())
    #util_secom.write_data('7_spe_test_ae', spe_test.numpy())
    #util_secom.write_data('7_T2_train_ae', T2_train.numpy())
    #util_secom.write_data('7_T2_test_ae', T2_test.numpy())
