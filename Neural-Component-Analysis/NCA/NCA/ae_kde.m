...
clear all;
% 
Gtrain = importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/1_T2_train.dat');
Gtest = importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/1_T2_test.dat');

for i = 1:size(Gtrain,1)
    t2(i) = Gtrain(i, :)*cov(Gtrain)*Gtrain(i, :)';
end  
    
for i = 1:size(Gtest,1)
    XTt2(i) = Gtest(i, :)*cov(Gtest)*Gtest(i, :)';
end  

SPE = importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/1_spe_train.dat');
XTSPE = importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/1_spe_test.dat');
SPE = SPE';
XTSPE = XTSPE';
...
happen=160;
 ...
 d00=importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/d00_te.dat');
 d02=importdata('/Users/liulang/Desktop/WSAE_Resnext/codes/Neural-Component-Analysis-master/data/d02_te.dat');
 X=d00;
 XT=d02;
[X,mean,std]=zscore(X);
