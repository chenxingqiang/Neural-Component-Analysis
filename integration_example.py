...
def integrate_spe_detector():
    ...
    try:
        ...
        success = detector.load_model('te_spe_detector.pth')
        if not success:
        ...
        detector.save_model('te_spe_detector.pth')
        ...
        plt.savefig('spe_detector_training_loss.png')
        plt.close()
        print("Training loss plot saved to 'spe_detector_training_loss.png'")
    ...
    # Plot results
    detector.plot_results(X_test, happen, save_path='spe_detector_results.png')
    print("Results plot saved to 'spe_detector_results.png'")
...
def real_time_monitoring_simulation():
    ...
    plt.tight_layout()
    plt.savefig('real_time_monitoring.png')
    plt.close()
    
    print("\nReal-time monitoring simulation completed")
    print(f"Results saved to 'real_time_monitoring.png'")
